...
public class RegistrationPage {
    ...
    public  void fillOutRegistrationForm( List<Map<String, String>> registrationTestDataListOfMap){
        ...
        if (firstRow.get("ssn") != null) {
            ...
            ssnTxt.sendKeys(mockData.generateSsn());}
        }

        if (firstRow.get("email") != null) {
            if(firstRow.get("email").equalsIgnoreCase("random")){
            emailAddressTxt.sendKeys(mockData.generateRandomEmail());}
        }
        ...
        if (firstRow.get("termsCheckMarks") != null) {
            if(firstRow.get("termsCheckMarks").equalsIgnoreCase("true")){
